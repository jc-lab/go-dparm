...
import (
	...
	"github.com/jc-lab/go-dparm/diskfs/filesystem/fat32"
	"github.com/jc-lab/go-dparm/diskfs/testhelper"
...
func TestFat32Label(t *testing.T) {
	t.Run("read-label", func(t *testing.T) {
		...
		// validate the label
		label := fs.Label()
		if label != "github.com/jc-lab/go-dparm/diskfs" {
			t.Errorf("Unexpected label '%s', expected '%s'", label, "github.com/jc-lab/go-dparm/diskfs")
		}
	})
	...
	t.Run("create-label", func(t *testing.T) {
		...
		fs, err := fat32.Create(f, fileInfo.Size(), 0, 512, "github.com/jc-lab/go-dparm/diskfs")
		if err != nil {

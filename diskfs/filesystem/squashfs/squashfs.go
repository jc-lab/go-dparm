...
//
// Note, however, that it is much easier to do this using the higher-level APIs at github.com/jc-lab/go-dparm/diskfs
...
func Create(f util.File, size, start, blocksize int64) (*FileSystem, error) {
	...
	tmpdir, err := os.MkdirTemp("", "github.com/jc-lab/go-dparm/diskfs_squashfs")
	if err != nil {

...
//
// mbr.Table implements the Table interface in github.com/jc-lab/go-dparm/diskfs/partition
//
// Normally, the best way to interact with a disk is to use the github.com/jc-lab/go-dparm/diskfs package,
